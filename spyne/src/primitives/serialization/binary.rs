use crate::primitives::serialization::{Deserialize, Deserializer, Serialize, Serializer};
...
mod test {
    use super::*;
    use crate::primitives::serialization::{Serialize, Serializer, Deserialize, Deserializer};
